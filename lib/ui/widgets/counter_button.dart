...
class CounterButton extends StatelessWidget {
  ...
  Widget button(Icon icon, Function() onTap) {
    return RawMaterialButton(
      ...
      fillColor: AppColor.accent, onPressed: () => onTap(), child: icon,
    );
  }
  ...
  List<Widget> body() {
    return [
      button(
        const Icon(Icons.remove, color: Colors.white), onDecrementTap,
      ),
      Padding(
      ...
      button(
          const Icon(Icons.add, color: Colors.white), onIncrementTap,
      ),
    ];
  }
